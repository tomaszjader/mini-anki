(function () {
  const translations = {
    pl: {
      ...
      importDoneWithErrors: "Zaimportowano kart: {count}. Pominięto duplikatów: {skipped}. Błędnych kart: {failed}. Pierwsze błędy: {errors}",
    ...
    en: {
      ...
      importDoneWithErrors: "Imported cards: {count}. Skipped duplicates: {skipped}. Invalid cards: {failed}. First errors: {errors}",
